...
#
# 命名空间(Namespace)
# 是从名称到对象的映射，大部分的命名空间都是通过
# Python
# 字典来实现的。
#
# 命名空间提供了在项目中避免名字冲突的一种方法。各个命名空间是独立的，没有任何关系的，所以一个命名空间中不能有重名，但不同的命名空间是可以重名而没有任何影响。
#
# 我们举一个计算机系统中的例子，一个文件夹(目录)
# 中可以包含多个文件夹，每个文件夹中不能有相同的文件名，但不同文件夹中的文件可以重名。
#
#
#
# 一般有三种命名空间：
#
# 内置名称（built - in names）， Python
# 语言内置的名称，比如函数名
# abs、char
# 和异常名称
